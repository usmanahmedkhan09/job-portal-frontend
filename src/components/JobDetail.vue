...
// let job = {
//   title: 'Call Center Dialer Operator (Night-Shift)',
//   company: 'Poshnee Tech (SMC PVT) LTD',
//   companyLink: '#',
//   rating: '3.0',
//   location: 'Rawalpindi',
//   salary: 'Rs 50,000 - Rs 100,000 a month',
//   type: 'Full-time',
//   role: 'Dialer Operator',
//   description:
//     'We are seeking a highly skilled and dedicated Dialer Operator to join our dynamic call center team...',
//   requirements: [
//     'Minimum 1 year of experience in a similar role.',
//     'Strong technical knowledge of dialer systems.',
//     'Excellent communication and problem-solving skills.',
//     'Ability to work night shifts.',
//     'Good knowledge of call center operations.',
//   ],
// };
</script>
...
<template>
  <div
    class="bg-white shadow-md rounded-lg p-6 max-w-2xl mx-auto border border-gray-200"
  >
    <!-- Job Title -->
    ...
    <div class="text-gray-600 text-sm flex items-center gap-2 mt-2">
      ...
      •
      <span class="flex items-center"> ⭐ {{ job.rating || 4.5 }} </span>
    </div>
    ...
    <div class="border-t border-gray-300 mt-6 pt-4">
      ...
      <p class="flex items-center gap-2 mt-1">📍 {{ job.location }}</p>
    </div>
